...
const ProductCard = ({ title, description, image }) => {
  return (
    <div className="bg-white border border-indigo-100 rounded-2xl shadow-sm w-37 sm:w-[230px] -m-1 overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <img
        src={image}
        alt={title}
